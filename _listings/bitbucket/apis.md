...
- name: Bitbucket
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/issues/master/_listings/bitbucket/repositories-username-repo-slug-issues-issue-id-vote-delete.md
x-common:
- type: x-developer
