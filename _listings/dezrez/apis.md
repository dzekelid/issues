...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/issues/master/_listings/dezrez/apis.md
specificationVersion: "0.14"
apis:
- name: Dezrez.Rezi.Client.Api - Issues an API key for use with the simple role/search
    endpoints
  x-api-slug: apiagencyapikey-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/issues/master/_listings/dezrez/apiagencyapikey-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Allows business workflows to post system issues to
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/issues/master/_listings/dezrez/apicoreplatformstateplatformissue-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Sends alerts for all current platform issues.
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/issues/master/_listings/dezrez/apicoreplatformstatesendpendingalerts-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/issues/master/_listings/dezrez/apicoreplatformstatesendpendingalerts-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Issues a request that a job be cancelled if possbile
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/issues/master/_listings/dezrez/apijob-post-openapi.md
- name: "Dezrez.Rezi.Client.Api - Creates or Updates Email Sync Security Credentials\r\nThis
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/issues/master/_listings/dezrez/apicredentialsemailsyncusernamepassword-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Issues an API key for use with the simple role/search
    endpoints
  x-api-slug: apiagencyapikey-post
  description: Issues an api key for use with the simple role/search endpoints.
